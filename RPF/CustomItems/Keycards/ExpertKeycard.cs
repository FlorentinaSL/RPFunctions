...
public class ExpertKeycard : CustomKeycard
{
    ...
    public override string Description { get; set; } = "Expert Guard Keycard per il ruolo Expert Guard";
    ...
    {
        Log.Info("[RPF - CustomKeycard]: Carta Expert registrata SUCCESS");
        base.SubscribeEvents();
    }

    protected override void UnsubscribeEvents()
    {
        Log.Info("[RPF - CustomKeycard]: Carta Expert de-registrata SUCCESS");
